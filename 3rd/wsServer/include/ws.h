...
/* External usage. */
extern const char*  ws_get_session_id(ws_cli_conn_t* client);
extern void         ws_set_session_id(ws_cli_conn_t* client);
extern int          ws_get_client_sock(ws_cli_conn_t* client);
extern size_t       ws_size_of_cli_conn();
